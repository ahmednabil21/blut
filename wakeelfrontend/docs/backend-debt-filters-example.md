...
- `?DueDateFrom=2024-01-01&DueDateTo=2024-02-28` — استحقاق ضمن النطاق
- `?DebtStatus=0` — غير مدفوع فقط
- `?DebtStatus=1` — مدفوع فقط
- دمج: `GET /api/Debts?Page=1&PageSize=10&DebtDescription=اشتراك&DueDateFrom=2024-01-01&DueDateTo=2024-03-31&DebtStatus=0`
